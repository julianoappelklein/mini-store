...
echo "3. Replace 'julianoappelklein' in examples with your GitHub username"
...
echo "   https://cdn.jsdelivr.net/gh/julianoappelklein/mini-store@latest/dist/mini-store.browser.min.js"
echo ""
